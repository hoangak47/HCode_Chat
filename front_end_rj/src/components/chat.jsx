        ...
        <div className="flex flex-col-reverse flex-1 overflow-y-auto ">
            {Array(10)
                ...
                .map((item, index) => (
                    <div
                        key={index}
                        className={`flex flex-col px-4 py-2 ${index % 2 === 0 ? 'items-start' : 'items-end'}`}
                    >
                        <div className="flex flex-col px-6 py-3 rounded-lg mb-4 relative min-w-[50px] max-w-[70%] bg-gray-200 text-black ml-7 items-end">
                            <span className="animate-pulse w-20 h-4 bg-gray-200 rounded-sm mb-1"></span>
                        </div>
                        <div className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-200 text-black">
                            <div className="animate-pulse w-6 h-6 rounded-full bg-gray-200 text-black inline-block"></div>
                        </div>
                    </div>
                ))}
        </div>
...
function Chat({ message_, user, page, setPage, loading }) {
